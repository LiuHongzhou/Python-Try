...
from INTERO.app.dbORM import User
from wtforms import TextAreaField, SelectField
from wtforms.widgets import TextArea
import INTERO.app.temp.thumb
...
from moduleGlobal import app, admin, qiniu, QINIU_DOMAIN, CATEGORY, UPLOAD_URL
import time
...
class GzhView(ModelView):
    ...
    form_extra_fields = {
        'img': ImageUpload('Image', base_path=UPLOAD_URL, relative_path=INTERO.app.temp.thumb.relativePath(), url_relative_path=QINIU_DOMAIN),
